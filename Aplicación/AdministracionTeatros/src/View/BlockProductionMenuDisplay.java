...
public class BlockProductionMenuDisplay extends javax.swing.JFrame {
    
    public DefaultTableModel tableModel;
    private final int ColumnAmount = 2;

    public BlockProductionMenuDisplay() {
        initComponents();
        this.tableModel = (DefaultTableModel) jTable_Blocks.getModel();
        initTable();
    }
    ...
    public void filterSearch(){
        ...
        jTable_Blocks.setRowSorter(sorter);
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("ELECCION DE BLOQUE");
        ...
        jScrollPane2.setViewportView(jTable_Blocks);
