...
public class PurchaseHistoryDisplay extends javax.swing.JFrame {
    
    public DefaultTableModel tableModel;
    private final int ColumnAmount = 9;

    public PurchaseHistoryDisplay() {
        initComponents();
        this.tableModel = (DefaultTableModel) jTable_Payments.getModel();
        initTable();
    }
    ...
    public void filterSearch(){
        ...
        jTable_Payments.setRowSorter(sorter);
    ...
    private void initTable(){
        ...
        for (int i = 0; i < ColumnAmount; i++)
            jTable_Payments.getColumnModel().getColumn(i).setCellRenderer(renderer);
    }
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("HISTORIAL DE PAGOS");
        ...
        jTable_Payments.setFont(new java.awt.Font("Gill Sans MT", 0, 18)); // NOI18N
        jTable_Payments.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Hora Compra", "Bloque", "Cantidad Asientos", "Costo Total", "Tipo Pago", "Codigo", "Obra", "Presentacion", "Cliente"
            }
        ) {
        ...
        jTable_Payments.getTableHeader().setReorderingAllowed(false);
        ...
        jPanel_BGLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_BGLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_BGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton_Back, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
    ...
    public javax.swing.JTable jTable_Payments;
