...
public class TheaterMenuDisplay extends javax.swing.JFrame {
    
    public DefaultTableModel tableModel;
    private final int ColumnAmount = 1;

    public TheaterMenuDisplay() {
        initComponents();
        this.tableModel = (DefaultTableModel) jTable_Theaters.getModel();
        initTable();
    }
    ...
    public void filterSearch(){
        ...
        jTable_Theaters.setRowSorter(sorter);
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("ELEGIR TEATRO");
