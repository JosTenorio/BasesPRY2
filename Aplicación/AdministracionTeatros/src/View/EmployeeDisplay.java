...
public class EmployeeDisplay extends javax.swing.JFrame {
    ...
    private final int ColumnAmount = 12;

    public EmployeeDisplay() {
        initComponents();
        this.tableModel = (DefaultTableModel) jTable_Employees.getModel();
        initTable();
    }
    ...
    private void initTable(){
        ...
        for (int i = 0; i < ColumnAmount; i++)
            jTable_Employees.getColumnModel().getColumn(i).setCellRenderer(renderer);
    }
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("EMPLEADOS");
        ...
        jTable_Employees.setFont(new java.awt.Font("Gill Sans MT", 0, 18)); // NOI18N
        jTable_Employees.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Cedula", "Nombre", "Fecha Nacimiento", "Sexo", "Direccion", "Correo", "Tel Celular", "Tel Casa", "Tel Otro", "Usuario", "Tipo", "Teatro"
            }
        ) {
        ...
        jTable_Employees.getTableHeader().setReorderingAllowed(false);
    ...
    public javax.swing.JTable jTable_Employees;
