...
-- distributed transaction and XA support for the Microsoft JDBC Driver 7.4 for SQL Server.
...
-- #2. Permissions to the distributed transaction support procedures for the Microsoft JDBC Driver 7.4 
...
-- in Microsoft JDBC Driver 7.4 for SQL Server distributed transactions.
