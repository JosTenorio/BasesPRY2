...
/****** Object:  Job [ActualizaciónRoles]    Script Date: 24/7/2020 13:46:24 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 24/7/2020 13:46:24 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ActualizaciónRoles', 
		...
		@owner_login_name=N'Jota-PC\Jota', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [ActulizarRoles]    Script Date: 24/7/2020 13:46:24 ******/
